    ...
    <main className="min-h-screen bg-[#020617] text-white relative overflow-hidden">
      ...
      {PLAYOFF_MODE && (
        <>
          ...
          {/* BADGE */}
          <div class="fixed top-4 left-1/2 -translate-x-1/2 z-50 pt-24">
          <div class="px-6 py-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 backdrop-blur-xl text-cyan-200 text-xs sm:text-sm font-bold tracking-[0.25em] shadow-[0_0_35px_rgba(34,211,238,0.2)] animate-pulse">⚡ PLAYOFF MODE</div>
          </div>
        </>
      )}
